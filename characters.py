...
AI_LIST = [
    {
        ...
        "lookahead": 0,  # 1 to 6
        "mistakes": 0.00,  # 0.0 to 1.0; odds of making mistake
        "fitness": "self", # options: self, other, balance
    ...
    },
    {
        ...
        "lookahead": 1,  # 1 to 6
        "mistakes": 0.20,  # 0.0 to 1.0; odds of making mistake
        "fitness": "balance", # options: self, other, balance
    ...
    },
    {
        ...
        "strategy": "negamax",  # options: "random", "negamax"
        "lookahead": 1,  # 1 to 6
        "mistakes": 0.05,  # 0.0 to 1.0; odds of making mistake
        "fitness": "balance", # options: self, other, balance
    ...
    },
    {
        ...
        "strategy": "negamax",  # options: "random", "negamax"
        "lookahead": 2,  # 1 to 6
        "mistakes": 0.02,  # 0.0 to 1.0; odds of making mistake
        "fitness": "balance", # options: self, other, balance
    ...
    },
    {
        ...
        "lookahead": 3,  # 1 to 6
        "mistakes": 0.00,  # 0.0 to 1.0; odds of making mistake
        "fitness": "other", # options: self, other, balance
    ...
    },
    {
        ...
        "strategy": "negamax",  # options: "random", "negamax"
        "lookahead": 4,  # 1 to 6
        "mistakes": 0.03,  # 0.0 to 1.0; odds of making mistake
        "fitness": "self", # options: self, other, balance
    ...
    },
    {
        ...
        "strategy": "negamax",  # options: "random", "negamax"
        "lookahead": 6,  # 1 to 6
        "mistakes": 0.01,  # 0.0 to 1.0; odds of making mistake
        "fitness": "balance", # options: self, other, balance
        "desc": "Sandra is very good. Plays regularly.",
        "tagline": "High difficulty. Mistakes very rare."
    },
    {
        "name": "R3 UNIT",
        "rank": "11",
